...
class LoadingImage:
    def __init__(self):
        global TESTINGGAME
        self.loading_state_image = {
            "backGround":load_image('loading_image_pix.png'),
         "loadingBar": load_image('loading_bar.png')
        }

        self.object_player_image = {"player_body": load_image("player_body_pix2.png"),
            "player_barrel": load_image('player_barrel_pix2.png')
        }
        self.object_player_colBox_image = {
            "player_colBox": load_image("player_box.png")
        }
        self.object_enemy_image = {
            "bagic_enemy": load_image('bagic_enemy.png'),
            "middle_enemy":load_image('middle_enemy.png')
        }
        if TESTINGGAME:
            self.object_enemy_colBox_image = {
            "bagic_enemy": load_image('bagic_enemy_box.png')
        }
        self.object_projectile_image = {
            "cannonball":load_image('cannonball.png'),
            "fireball":load_image('missile.png'),
            "energy":load_image("energy.png")
        }
        #self.object_projectile_image["cannonball"].
        self.object_structure_image = {"blocks":load_image("structure_block_fix.png")
        }
        self.map_terrain_image = {"base":load_image("base_fix.png")
        }
        self.main_menu_image = {"background":load_image("background_fix.png"),
            "battleUI":load_image("battleUI.png"),
            "selectUI":load_image("selectUI.png"),
            "mainFont":load_image("mainFont_fix.png"),
            "bagic_player":load_image("select2.png"),
            "super_player":load_image("select1.png"),
            "goUI":load_image("goUI.png"),
...
class LoadingSound():
    def __init__(self):
        self.playerSound = {
            "cannonball":[load_music("player_fire_cannon.mp3"),load_music("player_fire_cannon2.mp3")],
            "fireball": [load_music("player_fire_fireball.mp3"),load_music("player_fire_fireball2.mp3"),load_music("player_fire_fireball3.mp3")],
            "energy": [load_music("player_fire_energy.mp3")],
        ...
        self.bgSound = {
            ...
            "main_menu":[load_music("main_menu.mp3"),load_music("main_hell.mp3")],
            "select_menu":load_music("select_hell.mp3"),
            "ingame1":[load_music("ingame_bg.mp3"), load_wav("ingame_bg2.wav"), load_music("ingame_bg3.mp3")],
            "ingame2":[load_music("ingame_bgm2.mp3"), load_wav("ingame_bg4.wav"), load_music("ingame_bgm2.mp3")],
            "ingameBGM":load_music("ingame_bgm.mp3")
        ...
        self.uiSound ={
            ...
            "select_click":load_music("click3.mp3")
        }
